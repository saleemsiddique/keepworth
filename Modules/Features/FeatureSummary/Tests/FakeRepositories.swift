...
///
/// A copy of the ones in `KeepworthDomain`'s test target, which a feature cannot reach: test
/// targets do not export their code. Kept deliberately faithful to the SQLite implementations
